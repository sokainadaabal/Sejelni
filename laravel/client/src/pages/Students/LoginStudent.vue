            ...
            <v-card class="elevation-1 pa-2">
              <v-card-text>
                <div class="layout column align-center">
                  ...
                  <h1 class="flex my-4 " style="color:#1b5299;">SEJELNI - Student </h1>
                  <h4 class="flex my-4 " style="text-align:center;color:#1b5290;">Connecter pour suivre Votre Dossier</h4>
                </div>
                <v-form>
                  <v-text-field
                    append-icon="person"
...
export default {
  ...
  methods: {
    ...
    login() {
            ...
            axios.post('api/auth/loginStudent', { email, password })
              .then((res) => {
